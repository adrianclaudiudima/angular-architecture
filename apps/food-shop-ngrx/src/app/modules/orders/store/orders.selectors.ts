...
export const getSelectedOrder = createSelector<OrdersState, OrdersState, DomainEntity<Order | undefined>>(
  getOrdersState,
  (s1) => s1.selectedOrder
);

export const isOrderDetailsLoaded = (orderId: string) =>
  createSelector<OrdersState, DomainEntity<Order | undefined>, boolean>(getSelectedOrder, (s1) => {
